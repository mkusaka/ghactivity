  ...
  return (
    <div className="mx-auto max-w-5xl w-full">
      ...
      <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-gray-900 dark:text-slate-100 inline-flex items-center gap-2">
          ...
          <p className="text-sm text-gray-600 dark:text-slate-400">Timeline of public (or authorized) events.</p>
        </div>
        <div className="flex gap-2 items-center">
          <button
            onClick={onRefresh}
            disabled={isPending}
            className="px-3 py-2 rounded-lg bg-white dark:bg-slate-900 text-gray-700 dark:text-slate-100 border border-gray-200 dark:border-slate-800 hover:bg-gray-50 hover:border-gray-300 dark:hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-2 transition-all duration-200"
          >
          ...
          <button
            ...
            className="px-3 py-2 rounded-lg bg-white dark:bg-slate-900 text-gray-700 dark:text-slate-100 border border-gray-200 dark:border-slate-800 hover:bg-gray-50 hover:border-gray-300 dark:hover:bg-slate-800 inline-flex items-center gap-2 transition-all duration-200"
          >
      ...
      <section className="mt-6 p-4 rounded-xl bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800">
...
function Stat({ label, value, icon }: { label: string; value: string | number; icon: React.ReactNode }) {
  return (
    <motion.div
      layout
      className="p-4 rounded-xl bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 flex items-center gap-3 hover:border-gray-300 dark:hover:border-slate-700 transition-colors duration-200"
    >
      <div className="p-2 rounded-lg bg-gray-100 dark:bg-slate-800">{icon}</div>
      <div>
        <div className="text-xs text-gray-600 dark:text-slate-400">{label}</div>
        <div className="text-lg font-semibold text-gray-900 dark:text-slate-100">{String(value)}</div>
      </div>
    </motion.div>
  );
}
  ...
  return (
    <div className="flex flex-wrap gap-2">
        ...
        return (
          <button
            ...
            className={`px-3 py-1 rounded-full text-xs border transition-all duration-200 ${
              isSelected
                ? "bg-indigo-600 dark:bg-slate-100 text-white dark:text-slate-900 border-indigo-600 dark:border-slate-100 shadow-sm shadow-indigo-600/20"
                : "bg-white dark:bg-slate-900 text-gray-700 dark:text-slate-300 border-gray-300 dark:border-slate-700 hover:bg-gray-50 hover:border-gray-400 dark:hover:bg-slate-800"
            }`}
      ...
      <button
        ...
        className="px-3 py-1 rounded-full text-xs bg-white dark:bg-slate-900 text-gray-700 dark:text-slate-300 border border-gray-300 dark:border-slate-700 hover:bg-gray-50 hover:border-gray-400 dark:hover:bg-slate-800 transition-all duration-200"
      >
        Clear
      </button>
    </div>
