  ...
  return (
    <div className="mx-auto max-w-5xl w-full">
      ...
      <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h1 className="text-2xl sm:text-3xl font-semibold tracking-tight text-gray-900 dark:text-white inline-flex items-center gap-2">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">Timeline of public (or authorized) events.</p>
        </div>
        <div className="flex gap-2 items-center">
          <button
            onClick={onRefresh}
            disabled={isPending}
            className="px-3 py-2 rounded-lg bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-600 hover:bg-gray-50 hover:border-gray-300 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-2 transition-all duration-200"
          >
          ...
          <button
            ...
            className="px-3 py-2 rounded-lg bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 border border-gray-200 dark:border-gray-600 hover:bg-gray-50 hover:border-gray-300 dark:hover:bg-gray-700 inline-flex items-center gap-2 transition-all duration-200"
          >
      ...
      <section className="mt-6 p-4 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600">
...
function Stat({ label, value, icon }: { label: string; value: string | number; icon: React.ReactNode }) {
  return (
    <motion.div
      layout
      className="p-4 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 flex items-center gap-3 hover:border-gray-300 dark:hover:border-gray-500 transition-colors duration-200"
    >
  ...
  return (
    <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            className={`px-3 py-1 rounded-full text-xs border transition-all duration-200 ${
              isSelected
                ...
                : "bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-600 hover:bg-gray-50 hover:border-gray-400 dark:hover:bg-gray-600"
            }`}
      ...
      <button
        ...
        className="px-3 py-1 rounded-full text-xs bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 hover:border-gray-400 dark:hover:bg-gray-600 transition-all duration-200"
      >
        Clear
      </button>
    </div>
